...
<div className="text-center mt-12 p-6 bg-gray-50 rounded-lg max-w-2xl mx-auto">
  ...
  <p className="text-gray-600">
    The Gmail Drive connector is fully operational and ready for use. Follow the configuration guide above for your setup type (Enterprise or Individual), or reach out to our support team if you need assistance.
  </p>
</div>
