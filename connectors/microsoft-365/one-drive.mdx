...
<div className="flex flex-col items-center justify-center text-center pt-10">
  <h1 className="text-4xl font-bold">✅ OneDrive Connector Ready</h1>
...
<div className="max-w-2xl mx-auto mt-12">
  <div className="p-6 border rounded-lg bg-blue-50">
    <div className="flex items-center mb-4">
      ...
      />
      <h2 className="text-2xl font-semibold m-0"> Microsoft OneDrive</h2>
    </div>
...
<div className="text-center mt-12 p-6 bg-gray-50 rounded-lg max-w-2xl mx-auto">
  ...
  <p className="text-gray-600">
    The OneDrive connector is fully operational and ready for use. While we're finalizing the documentation, 
