---
title: "Teams"
description: "Team collaboration and communication connector"
icon: "/logo/teams.png"
---
...
<div className="max-w-2xl mx-auto mt-12">
  <div className="p-6 border rounded-lg bg-purple-50">
    <div className="flex items-center mb-4">
      ...
      />
      <h2 className="text-2xl font-semibold m-0"> Microsoft Teams</h2>
    </div>
    <p className="text-lg text-gray-700 mb-4">Team collaboration and communication</p>
