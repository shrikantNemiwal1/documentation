...
Client                                             Server
  |                                                  |
  | POST /userAccount/initAuth {email}               |
  |------------------------------------------------->|
  |                          Creates Redis session   |
  |                                                  |
  | 200 OK + x-session-token header                  |
  |<-------------------------------------------------|
  |                                                  |
  ...
  |                                                  |
  | If more steps: 200 OK {nextStep, allowedMethods} |
  |<-------------------------------------------------|
  |                                                  |
  | POST /userAccount/authenticate                   |
  | x-session-token: {token}                         |
  ...
  |                                                  |
  | If fully authenticated: 200 OK {accessToken, refreshToken} |
  |<-------------------------------------------------|
  |                                                  |
```
...
<CodeGroup>
  ...
  **Headers:**
  ...
  | Header | Value | Required | Description |
  |--------|-------|----------|-------------|
  | x-session-token | string | Yes | Session token from init request |
  ...
  **Request Body Parameters:**
  ...
  |-----------|------|----------|-------------|
  | method | string | Yes | Authentication method (password, otp, google, microsoft, azureAd, samlSso) |
  | credentials | object | Yes | Credentials for the specified method |
