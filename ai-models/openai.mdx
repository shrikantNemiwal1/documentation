...
- `gpt-4o` - OpenAI's latest model with improved capabilities
- `gpt-4-turbo` - Powerful model balancing cost and capability
- `gpt-3.5-turbo` - Faster, more cost-effective option for many use cases
